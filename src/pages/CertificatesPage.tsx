  ...
  return (
    <section className="section container page-section">
      <SectionTitle
        ...
        title="Lots suivis et analyses visibles"
        text="Chaque produit réel devra être relié à un certificat d'analyse, une fiche fournisseur, un lot et des précautions clairement lisibles."
      />
